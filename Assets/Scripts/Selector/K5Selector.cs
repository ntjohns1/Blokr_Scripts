...
namespace Blokr
{
    public class K5Selector : Selector
    {
        public override List<Vector2Int> GetOccupiedGridPositions(Vector2Int baseCell, Direction direction, bool isFlipped)
        {
            ...
            //     {
            //         Direction.Up => !isFlipped ? GetNext(cellB, Direction.Down) : GetNext(cellB, Direction.Up),
            //         Direction.Right => !isFlipped ? GetNext(cellB, Direction.Left) : GetNext(cellB, Direction.Right),
            //         Direction.Down => !isFlipped ? GetNext(cellB, Direction.Up) : GetNext(cellB, Direction.Down),
            //         Direction.Left => !isFlipped ? GetNext(cellB, Direction.Right) : GetNext(cellB, Direction.Left),
            //         _ => !isFlipped ? GetNext(cellB, Direction.Down) : GetNext(cellB, Direction.Up),
            //     };
