        ...
        private List<Vector2Int> GetOccupiedCellsForType(PieceType pieceType, Direction direction, Vector2Int gridPoint, GameObject tileHighlight)
        {
            ...
            switch (pieceType)
            {
                case PieceType.A1:
                    ...
                    return a1Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.A2:
                    ...
                    return a2Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.A3:
                    ...
                    return a3Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.B3:
                    ...
                    return b3Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.A4:
                    ...
                    return a4Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.B4:
                    ...
                    return b4Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.C4:
                    ...
                    return c4Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.D4:
                    ...
                    return d4Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.E4:
                    ...
                    return e4Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.A5:
                    ...
                    return a5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.B5:
                    ...
                    return b5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.C5:
                    ...
                    return c5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.D5:
                    ...
                    return d5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.E5:
                    ...
                    return e5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.F5:
                    ...
                    return f5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.G5:
                    ...
                    return g5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.H5:
                    ...
                    return h5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.I5:
                    ...
                    return i5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.J5:
                    ...
                    return j5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.K5:
                    ...
                    return k5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                case PieceType.L5:
                    ...
                    return l5Selector.GetOccupiedGridPositions(gridPoint, direction, false);
                default:
                    A1Selector a1 = tileHighlight.GetComponent<A1Selector>();
                    Debug.Log("Selector Direction: " + a1.SelectorDirection);
                    return a1.GetOccupiedGridPositions(gridPoint, direction, false);
            }
        }
