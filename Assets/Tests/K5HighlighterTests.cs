...
namespace Tests
{
    public class K5HighlighterTests
    {
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
        ...
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Up;
        ...
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Right;
        ...
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Down;
        ...
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void K5Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
        {
            K5Highlighter highlighter = new GameObject().AddComponent<K5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Left;
