...
// namespace Tests
// {
//     public class B3HighlighterTests
//     {

//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
//         {

//             B3Highlighter highlighter = new B3Highlighter();
...
//             Assert.AreEqual(new GridPosition(2, 3), result[10]);
//             Assert.AreEqual(new GridPosition(2, 2), result[11]);
//         }
//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
//         {
...
//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
//         {
//             B3Highlighter highlighter = new B3Highlighter();
//             GridPosition cellA = new GridPosition(3, 3);
...
//             Assert.AreEqual(new GridPosition(3, 2), result[10]);
//             Assert.AreEqual(new GridPosition(2, 2), result[11]);
//         }

//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
//         {
...
//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
//         {
//             B3Highlighter highlighter = new B3Highlighter();
//             GridPosition cellA = new GridPosition(3, 3);
...
//             Assert.AreEqual(new GridPosition(4, 2), result[9]);
//             Assert.AreEqual(new GridPosition(4, 3), result[10]);
//             Assert.AreEqual(new GridPosition(4, 4), result[11]);

//         }

//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             B3Highlighter highlighter = new B3Highlighter();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Down;
...
//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
//         {
//             B3Highlighter highlighter = new B3Highlighter();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void B3Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             B3Highlighter highlighter = new B3Highlighter();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Left;
