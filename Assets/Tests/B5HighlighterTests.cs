...
namespace Tests
{
    ...
    // B5Highlighter Tests
    // *********************************************************************
    public class B5HighlighterTests
    {

        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
        {

            B5Highlighter highlighter = new GameObject().AddComponent<B5Highlighter>();
            ...
            Assert.AreEqual(new GridPosition(5, 1), result[11]);
            Assert.AreEqual(new GridPosition(5, 2), result[12]);
            Assert.AreEqual(new GridPosition(5, 3), result[13]);
            Assert.AreEqual(new GridPosition(5, 4), result[14]);
            Assert.AreEqual(new GridPosition(4, 4), result[15]);
        }
        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new GridPosition(5, 5), result[11]);
        ...
        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new GridPosition(1, 1), result[11]);
            Assert.AreEqual(new GridPosition(2, 1), result[12]);
            Assert.AreEqual(new GridPosition(3, 1), result[13]);
            Assert.AreEqual(new GridPosition(4, 1), result[14]);
            Assert.AreEqual(new GridPosition(4, 2), result[15]);
        }

        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
        {
        ...
        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
        {
            B5Highlighter highlighter = new GameObject().AddComponent<B5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            ...
            Assert.AreEqual(new GridPosition(1, 5), result[11]);
            Assert.AreEqual(new GridPosition(1, 4), result[12]);
            Assert.AreEqual(new GridPosition(1, 3), result[13]);
            Assert.AreEqual(new GridPosition(1, 2), result[14]);
            Assert.AreEqual(new GridPosition(2, 2), result[15]);
        }

        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
        {
            B5Highlighter highlighter = new GameObject().AddComponent<B5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Down;
        ...
        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
        {
            B5Highlighter highlighter = new GameObject().AddComponent<B5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            ...
            Assert.AreEqual(new GridPosition(3, 5), result[13]);
            Assert.AreEqual(new GridPosition(2, 5), result[14]);
            Assert.AreEqual(new GridPosition(2, 4), result[15]);
        }

        [Test]
        public void B5Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
        {
            B5Highlighter highlighter = new GameObject().AddComponent<B5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Left;
