...
namespace Tests
{
    ...
    public class D5HighlighterTests
    {
        // *********************************************************************
        // D5Highlighter Tests
        // *********************************************************************
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Up;
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Right;
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Down;
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void D5Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
        {
            D5Highlighter highlighter = new GameObject().AddComponent<D5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Left;
