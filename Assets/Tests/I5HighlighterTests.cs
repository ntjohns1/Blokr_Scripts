...
namespace Tests
{
    public class I5HighlighterTests
    {
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
        ...
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Up;
        ...
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Right;
        ...
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Down;
        ...
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void I5Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
        {
            I5Highlighter highlighter = new GameObject().AddComponent<I5Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Left;
