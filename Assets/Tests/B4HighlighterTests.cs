...
// namespace Tests
// {
//     public class B4HighlighterTests
//     {

//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
//         {

//             B4Highlighter highlighter = new GameObject().AddComponent<B4Highlighter>();
...
//             Assert.AreEqual(new GridPosition(3, 1), result[7]);
//             Assert.AreEqual(new GridPosition(4, 1), result[8]);
//             Assert.AreEqual(new GridPosition(5, 1), result[9]);
...
//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
//         {
...
//             Assert.AreEqual(new GridPosition(3, 5), result[7]);
//             Assert.AreEqual(new GridPosition(4, 5), result[8]);
//             Assert.AreEqual(new GridPosition(5, 5), result[9]);
...
//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
//         {
//             B4Highlighter highlighter = new GameObject().AddComponent<B4Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//             Assert.AreEqual(new GridPosition(1, 3), result[7]);
//             Assert.AreEqual(new GridPosition(1, 2), result[8]);
//             Assert.AreEqual(new GridPosition(1, 1), result[9]);
...
//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
//         {
...
//             Assert.AreEqual(new GridPosition(5, 3), result[7]);
...
//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
//         {
//             B4Highlighter highlighter = new GameObject().AddComponent<B4Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//             Assert.AreEqual(new GridPosition(1, 5), result[9]);
...
//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             B4Highlighter highlighter = new GameObject().AddComponent<B4Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Down;
...
//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
//         {
//             B4Highlighter highlighter = new GameObject().AddComponent<B4Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void B4Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             B4Highlighter highlighter = new GameObject().AddComponent<B4Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Left;
