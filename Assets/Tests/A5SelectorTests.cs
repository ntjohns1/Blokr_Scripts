...
namespace Tests
{
    public class A5SelectorTests
    {
        ...
        public void A5Selector_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(0, 2), result[11]);
            Assert.AreEqual(new Vector2Int(0, 3), result[12]);
            Assert.AreEqual(new Vector2Int(0, 4), result[13]);
        ...
        public void A5Selector_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(6, 2), result[11]);
            Assert.AreEqual(new Vector2Int(6, 3), result[12]);
            Assert.AreEqual(new Vector2Int(6, 4), result[13]);
        ...
        public void A5Selector_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(2, 6), result[11]);
            Assert.AreEqual(new Vector2Int(3, 6), result[12]);
            Assert.AreEqual(new Vector2Int(4, 6), result[13]);
        ...
        public void A5Selector_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(2, 0), result[11]);
            Assert.AreEqual(new Vector2Int(3, 0), result[12]);
            Assert.AreEqual(new Vector2Int(4, 0), result[13]);
        ...
        public void A5Selector_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(6, 4), result[11]);
            Assert.AreEqual(new Vector2Int(6, 3), result[12]);
            Assert.AreEqual(new Vector2Int(6, 2), result[13]);
        ...
        public void A5Selector_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(0, 4), result[11]);
            Assert.AreEqual(new Vector2Int(0, 3), result[12]);
            Assert.AreEqual(new Vector2Int(0, 2), result[13]);
        ...
        public void A5Selector_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(4, 0), result[11]);
            Assert.AreEqual(new Vector2Int(3, 0), result[12]);
            Assert.AreEqual(new Vector2Int(2, 0), result[13]);
            Assert.AreEqual(new Vector2Int(2, 1), result[14]);
            Assert.AreEqual(new Vector2Int(2, 2), result[15]);
        ...
        public void A5Selector_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
        {
            ...
            Assert.AreEqual(new Vector2Int(4, 6), result[11]);
            Assert.AreEqual(new Vector2Int(3, 6), result[12]);
            Assert.AreEqual(new Vector2Int(2, 6), result[13]);
