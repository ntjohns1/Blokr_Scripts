...
// namespace Tests
// {
//     public class A5HighlighterTests
//     {

//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
//         {

//             A5Highlighter highlighter = new GameObject().AddComponent<A5Highlighter>();
...
//             Assert.AreEqual(new GridPosition(0, 2), result[11]);
//             Assert.AreEqual(new GridPosition(0, 3), result[12]);
//             Assert.AreEqual(new GridPosition(0, 4), result[13]);
//             Assert.AreEqual(new GridPosition(1, 4), result[14]);
//             Assert.AreEqual(new GridPosition(2, 4), result[15]);
//         }

//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
//         {
...
//             Assert.AreEqual(new GridPosition(6, 2), result[11]);
//             Assert.AreEqual(new GridPosition(6, 3), result[12]);
//             Assert.AreEqual(new GridPosition(6, 4), result[13]);
//             Assert.AreEqual(new GridPosition(5, 4), result[14]);
//             Assert.AreEqual(new GridPosition(4, 4), result[15]);
//         }

//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
//         {
//             A5Highlighter highlighter = new GameObject().AddComponent<A5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//             Assert.AreEqual(new GridPosition(2, 6), result[11]);
//             Assert.AreEqual(new GridPosition(3, 6), result[12]);
//             Assert.AreEqual(new GridPosition(4, 6), result[13]);
//             Assert.AreEqual(new GridPosition(4, 5), result[14]);
//             Assert.AreEqual(new GridPosition(4, 4), result[15]);
//         }

//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
//         {
...
//             Assert.AreEqual(new GridPosition(2, 0), result[11]);
//             Assert.AreEqual(new GridPosition(3, 0), result[12]);
//             Assert.AreEqual(new GridPosition(4, 0), result[13]);
//             Assert.AreEqual(new GridPosition(4, 1), result[14]);
//             Assert.AreEqual(new GridPosition(4, 2), result[15]);
//         }

//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
//         {
//             A5Highlighter highlighter = new GameObject().AddComponent<A5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//             Assert.AreEqual(new GridPosition(6, 4), result[11]);
//             Assert.AreEqual(new GridPosition(6, 3), result[12]);
//             Assert.AreEqual(new GridPosition(6, 2), result[13]);
//             Assert.AreEqual(new GridPosition(5, 2), result[14]);
//             Assert.AreEqual(new GridPosition(4, 2), result[15]);
//         }


//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             A5Highlighter highlighter = new GameObject().AddComponent<A5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Down;
...
//             Assert.AreEqual(new GridPosition(0, 4), result[11]);
//             Assert.AreEqual(new GridPosition(0, 3), result[12]);
//             Assert.AreEqual(new GridPosition(0, 2), result[13]);
//             Assert.AreEqual(new GridPosition(1, 2), result[14]);
//             Assert.AreEqual(new GridPosition(2, 2), result[15]);
//         }


//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
//         {
//             A5Highlighter highlighter = new GameObject().AddComponent<A5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//             Assert.AreEqual(new GridPosition(4, 0), result[11]);
//             Assert.AreEqual(new GridPosition(3, 0), result[12]);
//             Assert.AreEqual(new GridPosition(2, 0), result[13]);
//             Assert.AreEqual(new GridPosition(2, 1), result[14]);
//             Assert.AreEqual(new GridPosition(2, 2), result[15]);
...
//         [Test]
//         public void A5Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             A5Highlighter highlighter = new GameObject().AddComponent<A5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Left;
...
//             Assert.AreEqual(new GridPosition(4, 6), result[11]);
//             Assert.AreEqual(new GridPosition(3, 6), result[12]);
//             Assert.AreEqual(new GridPosition(2, 6), result[13]);
//             Assert.AreEqual(new GridPosition(2, 5), result[14]);
//             Assert.AreEqual(new GridPosition(2, 4), result[15]);
//         }
