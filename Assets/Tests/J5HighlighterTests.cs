...
// namespace Tests
// {
//     public class J5HighlighterTests
//     {
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
...
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Up;
...
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Right;
...
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Down;
...
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void J5Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             J5Highlighter highlighter = new GameObject().AddComponent<J5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Left;
