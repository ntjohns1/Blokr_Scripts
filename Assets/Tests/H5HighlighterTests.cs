...
// namespace Tests
// {
//     public class H5HighlighterTests
//     {
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
...
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Up;
...
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Right;
...
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Down;
...
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
...
//         [Test]
//         public void H5Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
//         {
//             H5Highlighter highlighter = new GameObject().AddComponent<H5Highlighter>();
//             GridPosition cellA = new GridPosition(3, 3);
//             Direction direction = Direction.Left;
