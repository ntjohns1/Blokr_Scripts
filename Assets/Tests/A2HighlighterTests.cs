...
namespace Tests
{
    public class A2HighlighterTests
    {

        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithUpDirection_ReturnsCorrectPositions()
        {

            A2Highlighter highlighter = new GameObject().AddComponent<A2Highlighter>();
        ...
        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithUpDirectionAndFlipped_ReturnsCorrectPositions()
        {
        ...
        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithRightDirection_ReturnsCorrectPositions()
        {
            A2Highlighter highlighter = new GameObject().AddComponent<A2Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithRightDirectionAndFlipped_ReturnsCorrectPositions()
        {
        ...
        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithDownDirection_ReturnsCorrectPositions()
        {
            A2Highlighter highlighter = new GameObject().AddComponent<A2Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithDownDirectionAndFlipped_ReturnsCorrectPositions()
        {
            A2Highlighter highlighter = new GameObject().AddComponent<A2Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Down;
        ...
        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithLeftDirection_ReturnsCorrectPositions()
        {
            A2Highlighter highlighter = new GameObject().AddComponent<A2Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
        ...
        [Test]
        public void A2Highlighter_GetOccupiedGridPositions_WithLeftDirectionAndFlipped_ReturnsCorrectPositions()
        {
            A2Highlighter highlighter = new GameObject().AddComponent<A2Highlighter>();
            GridPosition cellA = new GridPosition(3, 3);
            Direction direction = Direction.Left;
